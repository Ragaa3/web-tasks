    ...
    <div class="container pt-5">
        <div class="row align-items-center p-2">
            ...
            <form class="form-style p-4 text-white" method="GET" action="form.php">
                ...
                <div class="form-group">
                    <label class="text-center d-block" for="exampleInputEmail1">password</label>
                    <input name="password" type="password" class="form-control" id="exampleInputdate" aria-describedby="dateHelp" placeholder="Enter password">
